            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-2 col-sm-2">
                     <div class="logo"><a href="index.html"><img src="/shop/images/logo.png" alt="FlatShop"></a></div>
                  </div>
                        ...
                        <ul class="option">
                           ...
                           <li class="option-cart">
                              ...
                              <ul class="option-cart-item">
                                 <li>
                                    <div class="cart-item">
                                       <div class="image"><img src="/shop/images/products/thum/products-01.png" alt=""></div>
                                       ...
                                       <div class="right">
                                          ...
                                          <a href="#" class="remove"><img src="/shop/images/remove.png" alt="remove"></a>
                                       </div>
                                    </div>
                                 </li>
                                 <li>
                                    <div class="cart-item">
                                       <div class="image"><img src="/shop/images/products/thum/products-02.png" alt=""></div>
                                       <div class="item-description">
                                          <p class="name">Lincoln chair</p>
                                          <p>Size: <span class="light-red">One size</span><br>Quantity: <span class="light-red">01</span></p>
                                       </div>
